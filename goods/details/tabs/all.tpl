    ...
    <div class="goods-details__main">
        ...
        <div style="position: relative;">
            ...
            <div id="additional-btn-wrap" class="additional-btn-wrap {$record.sell_status}">
                ...
                <a href="javascript:;" id="open-one-click-order" class="additional-btn">Заказать в 1 клик</a>
            </div>
            {else}
        ...
        <div class="goods-details__delivery" id="js-delivery-block-content">
            <div>
                <span>Доставка в <a href="#" id="select-delivery-city" data-city-id="0">Выберите город</a></span>
                <a href="#" id="js-open-delivery-tab">Подробности о доставке ></a>
            </div>
                ...
                <tr>
                    <td>
                        <div>
                            ...
                            <span>Курьером по вашему адресу</span>
                        </div>
                    </td>
                    <td id="np-addr-pod">
                        по тарифам перевозчика
