{Banners->getBanners slot="also_need" goods=$section limit="20" assign="banners"}
                                        ...
                                        "ecommerce": {
                                            "promoClick": {
                                                "promotions": [
                                                    {
                                                        "id": {$banner.id},
                                                        "name": "{$banner.alt|replace:'/*br*/':' '|escape:'quotes' nofilter}"
                                                    }
                                                ]
                                            }
                                        }
                                ...
                                >
									...
									{if $banner.src_hover}
										<div class="icon_hover hidden">
											<img data-src="{$banner.src_hover}" alt="{$banner.alt}" class="lazyload" />
										</div>
									{/if}
									<div class="icon">
                                        {if $banner.template}
                                        ...
                                        {else}
											...
											{/if}
											{if $banner.src}
												<img data-src="{$banner.src}" alt="{$banner.alt}" class="lazyload">
											{/if}
                                        {/if}
									</div>
									{*if !$banner.template}
