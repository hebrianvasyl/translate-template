...
<div class="item mainpage-social-widgets-col fb_item" id="fb_widget"></div>

<script src="https://apis.google.com/js/platform.js"></script>
<script>
    App.addOnDomReady(function(){
//        var vk = '<iframe name="fXD20877147" width="100%" scrolling="no" height="289" frameborder="0" style="overflow: hidden; height: 289px;" src="http://vk.com/widget_groups.php?app=0&amp;width=270&amp;gid=129740351&amp;mode=1&amp;height=289&amp;no_cover=1"></iframe>';
