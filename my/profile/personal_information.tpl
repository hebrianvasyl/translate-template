    ...
    <section class="content-wrapper">
        <form class="personal-information check-lt" action="/cgi-bin/form.php?r={$menu.active.href|@urlencode}&action=editProfile" method="POST">
            ...
            <div class="user-info">
                ...
                <div class="check-form-i">
                    ...
                    <div class="checkout-fields">
                        <div style="text-align: right;">
                            <a href="#" name="change_password_link">Сменить пароль</a>
                        </div>
                        ...
                        <div class="new-password hidden" name="change_password_block">
							...
							<span class="btn-link btn-grey submit-btn">
								<input class="btn-link-i" type="submit" name="change_password_button" value="Сохранить">
							</span>
                            <p class="checkout-fields-i-options">Придумайте новый пароль</p>
                        </div>
                    </div>
                    <div class="clear"></div>
                </div>
                ...
                <div class="check-form-i">
                    <span class="check-form-i-text valigned-middle">Имя и фамилия</span>
                ...
                <div class="check-form-i" style="overflow: visible; position: relative;">
                    <div>
                        <span class="check-form-i-text valigned-middle">Эл. почтa</span>
                        <div class="popup_wrap">
                            <a class="info popup" href="#" id="checkout_email_popup" name="info-link"></a>
                            <div class="popup_body checkout_email_popup_body">Указывая свой электронный адрес, Вы с легкостью сможете отслеживать статус своего заказа и узнавать о новых акционных предложениях на нашем сайте.</div>
                        </div>
                    </div>
                ...
                <div class="check-form-i {if count($addresses) == 0}hidden{/if}">
                    <span class="check-form-i-text valigned-top field-text">Адрес{if count($addresses) > 1}а{/if} доставки</span>
                            ...
                            {foreach from=$addresses item="address"}
                                ...
                                <div class="addresses clearfix" id="address{$address.id}">
                                    ...
                                    <div class="checkout-fields-i float-lt">
                                        ...
                                        <span class="checkout-fields-i-options">Улица</span>
                                    </div>
                                    ...
                                    <div class="checkout-fields-i house-checkout-fields-i float-lt">
                                        ...
                                        <span class="checkout-fields-i-options">Дом</span>
                                    </div>
                                    <div class="checkout-fields-i flat-checkout-fields-i float-lt">
                                        ...
                                        <span class="checkout-fields-i-options">Квартира</span>
                                    </div>
                                    {if $user.user_type == 'dealer'}
                                    <a class="delete" href="{$menu.active.href}?action=removeAddress&data[address_id]={$address.id}" name="remove"><span class="underline">Удалить</span></a>
                                    {/if}
                                    <div class="clear"></div>
            ...
            <div class="check-form-i">
                <span class="check-form-i-text valigned-top"></span>
				<span class="btn-link btn-grey submit-btn">
					<input class="btn-link-i" type="submit" value="Сохранить">
				</span>
                <div class="clear"></div>
            </div>
        </form>
