<section class="b-signup" name="signup">
	<h1 class="b-signup-title">Регистрация постоянного клиента</h1>
	...
	<form class="f-signup" method="post" action="/cgi-bin/form.php?r={$menu.my->signup.href|@urlencode}&action=SignUp" name="submit-by-ajax">
		<div class="f-signup-step">
			<label class="f-signup-label basic" for="login">Номер телефона:</label>
			...
			<div class="f-signup-hint right">Будет использован в качестве<br>логина для входа на сайт</div>
			<div class="f-signup-hint bottom phone">Например, +38 (0XX) ХХХ-ХХ-ХХ</div>
		</div>

		<div class="f-signup-step">
			<label class="f-signup-label basic" for="password">Придумайте пароль:</label>
		...
		<div class="f-signup-step third">
			<label class="f-signup-label" for="user_title">Имя и фамилия:</label>
		...
		<div class="f-signup-step check-form-i_town">
			<label class="f-signup-label" for="city_id">Город:</label>
		...
		<div class="f-signup-step">
			<label class="f-signup-label" for="street">Адрес для службы доставки:</label>
		...
		<div class="f-signup-step optional">
			...
			<div class="f-signup-step-i">
				<label class="f-signup-label checkbox" for="subscribe_input">Я хочу получать по электронной почте уведомления об акциях и распродажах, проводимых интернет-магазином IntexPool.ua</label>

			</div>
		</div>
		<div class="f-signup-mail-wrap" id="email_block">
			<label class="f-signup-label" for="email">Мой адрес эл. почты:</label><input type="text" id="email" class="custom-field-error input-field" name="email" _pattern="{$new_user->email.pattern}" _required="required" class="f-signup-field mail" id="email" tabindex="9">
		</div>

		<div class="f-signup-step last-step">
			<span class="btn-link">
				<button type="submit" class="btn-link-i" tabindex="10">Зарегистрироваться</button>
			</span>
		</div>
