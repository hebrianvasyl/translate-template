...
<div style="display: flex;height: 22px;justify-content: flex-end;align-items: center;margin: 0;text-align: right;">
    ...
    <script>
        ...
        */
        var lang;
        var lang_url = getParameterByName('lang');
        if (lang_url && lang_url.length > 0) {
            if(lang_url === 'ru') {
                lang = 'ru|ru';
            } else if (lang_url === 'uk') {
                lang = 'ru|uk';
            ...
            lang = gt_get_cookie('lang').split('/').pop();
        }
        ...
        function translateTo(code) {
            ...
            if (code === 'ru|uk') {
                $('glang-ru').removeClass('active');
                $('glang-uk').addClass('active');
            } else {
                $('glang-uk').removeClass('active');
                $('glang-ru').addClass('active');
            }
        }
